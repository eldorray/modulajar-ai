    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                ...
                <p class="text-[hsl(var(--muted-foreground))]">Kelola data guru dan akun login dalam satu tempat.</p>
            </div>
            <a href="{{ route('admin.guru.create') }}" class="btn btn-primary w-full sm:w-auto">
                            ...
                            <tr>
                                <td colspan="7" class="text-center py-8">
                                    <div class="flex flex-col items-center gap-2">
                                        ...
                                        <p class="text-sm text-[hsl(var(--muted-foreground))]">Klik tombol "Tambah Guru" untuk membuat profil dan akun login guru.</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
